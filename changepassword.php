...
if ($_POST['submit'])
{
	...
	$queryget = mysql_query("SELECT Password FROM addcustomer WHERE Username= '$user'") or die("Query didnt work");
	...
	if ($oldpassword==$oldpassworddb)
	{
		...
		UPDATE addcustomer SET Password='$newpassword' WHERE Username='$user'
		");	
		session_destroy();
		die("Your Password has been changed. <a href='login.php'>Return To Login Page</a>");
...
{
echo"
<form name='changepass' method='POST' action='./changepassword.php'>
<fieldset>  
<table class='loginstyle'>  
<tr class='loginstyle'>  
<td class='loginstyle'><label for='username'><h4>Current Password :</h4></label></td><td><input type='text' name='oldpassword' size='30'></td>  
</tr>  
<tr>  
<td><label for='newpassword'><h4>New Password :</h4></label></td><td><input type='password' name='newpassword' size='30'></td>  
</tr>  
<tr>  
<td><label for='newpasswordrepeat'><h4>Repeat New Password :</h4></label></td><td><input type='password' name='repeatnewpassword' size='30'></td>  
</tr>  
<tr>  
<td class='submit'></td><td><input type='IMAGE' src='images/passbutton.png' name='submit' value='Change Password'></td>  
</tr>  
</table>  
</fieldset>  
</form> ";
...
<br /><br />
			...
			<div id="side">
				...
				<h3><a href='changeusername.php'>Change Username</a></h3>
			</div>
			<!-- /side -->
