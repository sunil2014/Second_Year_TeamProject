		...
		<div class="wrap">
			...
			<div id="pitch">
				<div id="slideshow">
					...
					<!-- 1st frame -->
					<div class="active">
						<img src="images/pitch/movies.jpg" alt="The Expendables" />
...
$query = "SELECT * FROM SV_MOVIES WHERE TYPE LIKE '$initialLetter%'";  
...
?> 
			...
			<div id="side">
				...
				<ul class="side-menu">
					<li><a href="movies.php?letter=">All</a></li>
					<li><a href="movies.php?letter=AC">Action</a></li>
					<li><a href="movies.php?letter=AD">Adventure</a></li>
					<li><a href="movies.php?letter=CO">Comedy</a></li>
					<li><a href="movies.php?letter=CR">Crime</a></li>
					<li><a href="movies.php?letter=D">Documentary</a></li>
					<li><a href="movies.php?letter=H">Horror</a></li>
					<li><a href="movies.php?letter=RO">Romantic</a></li>
					<li><a href="movies.php?letter=T">Thriller</a></li>
				</ul><br>
			</div>
			<!-- /side -->
		</div>
